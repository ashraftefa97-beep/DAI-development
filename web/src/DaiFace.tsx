...
export type DaiAvatarStyle='classic'|'minimal'|'cute'|'cyber'|'soft'|'pro'|'hologram'|'sakura'|'ocean'|'solar'|'midnight'|'mint'|'aurora'|'ember'|'rose'|'ice'|'lime'|'violet'|'pearl'|'crimson'|'galaxy'|'desert'|'lavender'|'matrix';
