...
Deno.serve(async (req) => {
  ...
  const prompt =
    `اتكلمي كمتكلمة واحدة فقط بالمصري الطبيعي، بصوت أنثوي شاب وخفيف وواضح وبسرعة محادثة نشيطة. ثبتي نفس خامة الصوت ونفس الطبقة والإيقاع من أول كلمة لآخر كلمة، وما تخفضيش طبقة الصوت أو تغيّري الشخصية في نهاية الجمل. النص فقط من غير أي إضافة:\n${text}`;
