...
Deno.serve(async (req) => {
  ...
  const prompt =
    'اقرئي النص التالي فقط بالمصري الطبيعي كأنك بتتكلمي مع شخص قدامك، مش بتقري سكريبت. استخدمي صوت أنثوي شاب ودافي وواثق، واضح وثابت الهوية من أول كلمة لآخر كلمة. ' +
    'قسمي الأداء لمجموعات تنفّس قصيرة من 4 لـ10 كلمات، مع وقفات خفيفة عند الفواصل ونهاية الفكرة. غيّري السرعة والتأكيد بدرجة بسيطة حسب المعنى، وركزي على الكلمات المهمة من غير مبالغة أو تمثيل زائد. ' +
    'تجنبي نبرة المذيع، الرتابة، السرعة الثابتة، وإن آخر الجملة يهبط لصوت غليظ. ما تضيفيش أي كلام مش موجود في النص.\n\n' +
    text;
