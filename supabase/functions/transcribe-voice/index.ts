...
Deno.serve(async (req) => {
  ...
  const instruction =
    ...
    'وحافظ على الـ code-switching بين العربي والإنجليزي كما نُطق. اكتب أسماء المنتجات والموديلات والاختصارات ' +
    'والأرقام والروابط بالصيغة الأقرب لنطقها، مثل Bambu Lab و3D وRTX وiPhone، بدل ترجمتها أو تعريبها بالقوة. ' +
    'اكتب الكلمات اللي اتقالت فقط بدون مقدمة، بدون شرح، وبدون علامات اقتباس. ' +
    'لو جزء مش واضح، حافظ على الأجزاء الواضحة ولا تخترع كلامًا غير مسموع.';
